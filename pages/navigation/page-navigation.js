...
import '/material/components/navigation/material-navigation.js';

const component = Component.meta(import.meta.url, 'page-navigation');
/**
  *
  */
...
Component.define(component, NavigationPage);
