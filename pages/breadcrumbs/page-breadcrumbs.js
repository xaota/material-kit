...
import '/material/components/breadcrumbs/material-breadcrumbs.js';

const component = Component.meta(import.meta.url, 'page-breadcrumbs');
/**
  *
  */
...
Component.define(component, BreadcrumbsPage);
